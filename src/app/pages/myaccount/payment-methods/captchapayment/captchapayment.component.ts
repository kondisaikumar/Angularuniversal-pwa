...
@Component({
  selector: 'app-captchapayment',
  templateUrl: './captchapayment.component.html',
  styleUrls: ['./captchapayment.component.scss']
})
export class CaptchapaymentComponent implements OnInit {
