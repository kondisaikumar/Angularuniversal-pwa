...
export class VantivPaymentServerSideApiService {
    ...
    constructor(private http: HttpClient,
        ...
        private errorHandler: ErrorHandlerService, private cookieService: CookieService,
    ...
    public parseSetupTransactionResponse(res) {
        this.vTransactionSetupID =  res;
    }
    ...
    private getCardPaymentRequestPayload(vTotalValue: number) {
        ...
        const vRefIdVantiv = `${this.customerSession.UserId.toString() + cartId.toString()}`;

        return {
            CartId: (this.cartService.cartdetails && this.cartService.cartdetails.CartId) || '',
            StoreId: this.customerSession.StoreId,
            SessionId: this.customerSession.SessionId,
            UserId: this.customerSession.UserId,
            AppId: this.customerSession.AppId,
